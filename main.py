...
def shorten_url(request: schemas.URLRequest, db: Session = Depends(get_db)):
    ...
    # print(new_url_mapping.short_url)

    # return new_url_mapping
    return schemas.URLResponse(
        original_url=new_url_mapping.original_url,
        short_url=new_url_mapping.short_url,
        access_count=new_url_mapping.access_count,
        expiration_date=new_url_mapping.expiration_date
    )
